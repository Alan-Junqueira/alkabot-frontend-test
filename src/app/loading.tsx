...
export default function Loading() {
  return (
    <div className="w-full h-screen bg-gradient-to-r from-gray-200 to-gray-300 animate-pulse bg-gray-400 bg-opacity-25">
      <div className="w-full h-24 bg-gradient-to-l from-gray-200 to-gray-300 animate-pulse bg-gray-400 bg-opacity-25"></div>
